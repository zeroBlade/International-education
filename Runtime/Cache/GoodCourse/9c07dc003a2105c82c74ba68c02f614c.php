...
<link href="/SIS.JXNU-B/Public/assets/global/plugins/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css" rel="stylesheet" type="text/css"/>
<link href="/SIS.JXNU-B/Public/assets/global/plugins/bootstrap-select/css/bootstrap-select.min.css" rel="stylesheet" type="text/css"/>
<link href="/SIS.JXNU-B/Public/assets/global/plugins/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css" rel="stylesheet" type="text/css"/>
<link href="/SIS.JXNU-B/Public/assets/global/plugins/datatables/plugins/bootstrap/dataTables.bootstrap.css" rel="stylesheet" type="text/css"/>
<link href="/SIS.JXNU-B/Public/assets/global/plugins/datatables/extensions/Responsive/css/dataTables.responsive.css" rel="stylesheet" type="text/css"/>
<link href="/SIS.JXNU-B/Public/assets/global/plugins/datatables/extensions/TableTools/css/dataTables.tableTools.css" rel="stylesheet" type="text/css"/>
<link href="/SIS.JXNU-B/Public/assets/global/plugins/jquery-fileapi/css/jquery-fileapi.custom.css" rel="stylesheet" type="text/css"/>
...
var _ROOT_ = '/SIS.JXNU-B',
    ...
    _ACTION_ = '/SIS.JXNU-B/index.php/GoodCourse/GoodCourse/all',
    _MODULE_ = '/SIS.JXNU-B/index.php/GoodCourse',
    _CONTROLLER_ = '/SIS.JXNU-B/index.php/GoodCourse/GoodCourse';
</script>
<!-- BEGIN CORE PLUGINS -->
<!--[if lt IE 9]>
...
<script src="/SIS.JXNU-B/Public/assets/global/plugins/datatables/media/js/jquery.dataTables.min.js" type="text/javascript"></script>
<script src="/SIS.JXNU-B/Public/assets/global/plugins/datatables/extensions/Responsive/js/dataTables.responsive.min.js" type="text/javascript"></script>
<script src="/SIS.JXNU-B/Public/assets/global/plugins/datatables/extensions/TableTools/js/dataTables.tableTools.min.js" type="text/javascript"></script>
<script src="/SIS.JXNU-B/Public/assets/global/plugins/datatables/plugins/bootstrap/dataTables.bootstrap.js" type="text/javascript"></script>
<script src="/SIS.JXNU-B/Public/assets/global/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js" type="text/javascript"></script>
<script src="/SIS.JXNU-B/Public/assets/global/plugins/bootstrap-select/js/bootstrap-select.min.js" type="text/javascript"></script>
...
<script src="/SIS.JXNU-B/Public/assets/global/plugins/jquery-fileapi/FileAPI/FileAPI.min.js" type="text/javascript"></script>
<script src="/SIS.JXNU-B/Public/assets/global/plugins/jquery-fileapi/FileAPI/FileAPI.exif.js" type="text/javascript"></script>
<script src="/SIS.JXNU-B/Public/assets/global/plugins/jquery-fileapi/jquery.fileapi.custom.js" type="text/javascript"></script>
<script src="/SIS.JXNU-B/Public/assets/global/scripts/datatable.js" type="text/javascript"></script>
<script src="/SIS.JXNU-B/Public/assets/global/scripts/jquery.hyall.js" type="text/javascript"></script>
<script src="/SIS.JXNU-B/Public/assets/global/scripts/hy-import.js" type="text/javascript"></script>
<?php echo ($_script); ?>
