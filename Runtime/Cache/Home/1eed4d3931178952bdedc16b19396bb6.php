    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            var _ROOT_ = '/SIS.JXNU-B',
                    ...
                    _ACTION_ = '/SIS.JXNU-B/index.php/Home/Article/category',
        ...
        <script type="text/javascript">
            ...
            window._SELF_='<?php echo urldecode("/SIS.JXNU-B/index.php/Home/Article/category/category_id/21/lan_id/2.html");?>';
        </script>
        <!-- BEGIN CORE SCRIPTS -->
