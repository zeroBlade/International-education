    ...
    <div class="container">
      ...
      <ul>
                        <a href="<?php echo U('GoodCourse/course');?>">
                            <li>
                                <i class=" glyphicon glyphicon-list-alt"></i> <span class="nav-text"></span>&nbsp;&nbsp;精品课程
                            </li>
                        </a>
                        <a href="<?php echo U('GoodCourse/teachers',array('course_id'=>$one_course['id']));?>">
                            <li>
                            <i class=" glyphicon glyphicon-list-alt"></i> <span class="nav-text"></span>&nbsp;&nbsp;课程团队
                            </li>
                        </a>
                        <span class="after"></span>
                        <a href="<?php echo U('GoodCourse/lesson',array('course_id'=>$one_course['id']));?>">
                            <li class="active">
                            <i class=" glyphicon glyphicon-list-alt"></i> <span class="nav-text"></span>&nbsp;&nbsp;课程介绍
                            </li>
                        </a>
                        ...
                        <a href="<?php echo U('GoodCourse/syllabus',array('course_id'=>$one_course['id']));?>">
                            <li>
                            <i class=" glyphicon glyphicon-list-alt"></i> <span class="nav-text"></span>&nbsp;&nbsp;教学大纲
                            </li>
                        </a>  
                         <span class="after"></span>
                        <a href="<?php echo U('GoodCourse/calendar',array('course_id'=>$one_course['id']));?>">
                            <li>
                            <i class=" glyphicon glyphicon-list-alt"></i> <span class="nav-text"></span>&nbsp;&nbsp;教学日历
                            </li>
                        </a>  
                        <span class="after"></span>
                        <a href="<?php echo U('GoodCourse/video_watch',array('course_id'=>$one_course['id']));?>">
                            <li>
                            <i class=" glyphicon glyphicon-list-alt"></i> <span class="nav-text"></span>&nbsp;&nbsp;教学视频
                            </li>
                        </a>                 
                        <span class="after"></span>
                        <a href="<?php echo U('GoodCourse/courseware',array('course_id'=>$one_course['id']));?>">
                            <li>
                            <i class=" glyphicon glyphicon-list-alt"></i> <span class="nav-text"></span>&nbsp;&nbsp;教学课件
                            </li>
                        </a>                          
                        <span class="after"></span>
                        <a href="<?php echo U('GoodCourse/homeWork',array('course_id'=>$one_course['id']));?>">
                            <li>
                            <i class=" glyphicon glyphicon-list-alt"></i> <span class="nav-text"></span>&nbsp;&nbsp;作业习题
                            </li>
                        </a>  
                         <span class="after"></span>
                        <a href="<?php echo U('GoodCourse/audio',array('course_id'=>$one_course['id']));?>">
                            <li>
                            <i class=" glyphicon glyphicon-list-alt"></i> <span class="nav-text"></span>&nbsp;&nbsp;音频素材
                            </li>
                        </a>     
                          <span class="after"></span>
                        <a href="<?php echo U('GoodCourse/vedio',array('course_id'=>$one_course['id']));?>">
                            <li>
                            <i class=" glyphicon glyphicon-list-alt"></i> <span class="nav-text"></span>&nbsp;&nbsp;视频素材
                            </li>
                        </a>    
                          <span class="after"></span>
                        <a href="<?php echo U('GoodCourse/resources',array('course_id'=>$one_course['id']));?>">
                            <li>
                            <i class=" glyphicon glyphicon-list-alt"></i> <span class="nav-text"></span>&nbsp;&nbsp;参考资料目录
                            </li>
                        </a>  
                         <span class="after"></span>
                        <a href="<?php echo U('GoodCourse/contact',array('course_id'=>$one_course['id']));?>">
                            <li>
                            <i class=" glyphicon glyphicon-list-alt"></i> <span class="nav-text"></span>&nbsp;&nbsp;辅助教学材料
                            </li>
                        </a>                                                                                  
                        <span class="after"></span>
                        <a href="<?php echo U('Question/askQuestion',array('course_id'=>$one_course['id']));?>">
                            <li>
                            <i class=" glyphicon glyphicon-list-alt"></i> <span class="nav-text"></span>&nbsp;&nbsp;课程讨论
                            </li>
                        </a>
                        <span class="after"></span>
                    </ul>
            ...
            <div class="col-md-8">
                <div class="headline top14">
                    ...
                    <h2 class="text-center">课程介绍</h2><br/>
                    <div class="pull-right">创建时间: <span><?php echo ($one_course['create_time']); ?></span> &nbsp;&nbsp;阅读：<span><?php echo ($one_course['hit']); ?></span>次 </div>
                    <br/>
                    <article><?php echo ($one_course['intro']); ?></article>
                </div>
            </div>
        </div>
    </div>
        ...
        <script type="text/javascript">
            ...
            var _ROOT_ = '/SIS.JXNU-B',
                    ...
                    _ACTION_ = '/SIS.JXNU-B/index.php/Home/GoodCourse/lesson',
        ...
        <script type="text/javascript">
            ...
            window._SELF_='<?php echo urldecode("/SIS.JXNU-B/index.php/Home/GoodCourse/lesson/course_id/150.html");?>';
        </script>
        <!-- BEGIN CORE SCRIPTS -->
